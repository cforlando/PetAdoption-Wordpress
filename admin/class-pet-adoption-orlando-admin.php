...
class Pet_Adoption_Orlando_Admin {
   ...
   */
  private $option_name = 'pet_adoption';
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/pet-adoption-orlando-admin.css', array(), $this->version, 'all' );
  ...
  public function add_options_page() {
    ...
    add_settings_section(
      ...
      __( 'General', 'pet-adoption' ),
      array( $this, $this->option_name . '_api_key' ),
      $this->plugin_name
    );
   ...
   * @since  1.0.0
   */
  public function pet_adoption_api_key() {
    $apikey = get_option( $this->option_name . '_api_key' );
    ?>
      <fieldset>
        <label>
          <input type="text" name="<?php echo $this->option_name . '_api_key' ?>" id="<?php echo $this->option_name . '_api_key' ?>" value="">
          <?php _e( 'API Key', 'pet-adoption' ); ?>
        </label>
      </fieldset>
    <?php
    echo '<p>Your API Key is '.$apikey.'</p>';
  }
